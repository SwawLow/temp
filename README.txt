...
et chaque cle est assigner une list de valeur qui comprend le nombre de fois un mot revien dans une list.
get_lines(): retourn une list qui comprend toutes les instance d'un mot reviens dans un dictionnaire
